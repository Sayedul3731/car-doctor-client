...
const Login = () => {
    ...
    return (
        <div className="hero min-h-screen bg-gradient-to-r from-red-500 to-green-500">
            <div className="hero-content flex-col lg:flex-row gap-10">
                <div className="text-center w-1/2">
                    <img src={img} alt="" />
                </div>
                <div className=" rounded-md w-full max-w-sm border-2 border-[#FF3811] ">
                    <form onSubmit={handleLogIn} className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <input type="password" name="password" placeholder="password" className="input input-bordered border-[#FF3811]" required />
                            <label className="label">
